...
export default (props) => {
    ...
    const constructNewAnimal = evt => {
        ...
        if (eId === 0) {
            ...
            if (emp.employeeLocations[0].locationId === loc.id) {
                ...
                window.alert("The selected employee does not work at the selected location, please choose an employee that works at a chosen location.")
            }
        }
    }
    ...
    return (
        <form className="animalForm">
            ...
            <div className="form-group">
                <label htmlFor="employee">Kennel Location</label>
                <select
                    defaultValue=""
                    name="employee"
                    id="employeeId"
            ...
            <div className="form-group">
                <label htmlFor="employee">Choose a caretaker for your dog</label>
                <select
                    defaultValue=""
                    name="employee"
                    id="employeeId"
